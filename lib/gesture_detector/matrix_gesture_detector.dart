...
class MatrixGestureDetector extends StatefulWidget {
  ...
  // The initial matrix position of the widget
  final Matrix4 initMatrixPos;
...
//  Matrix4 matrix = Matrix4.identity();
  ...
  void onScaleUpdate(ScaleUpdateDetails details) {
    ...
    print("Rotation details : " + details.rotation.toString() + "\n    rot delta : " + rotationUpdater.value.toString());
